 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | F13    |  F14 | LCtl | LAlt | LCmd |Bks/L1|Tab/L2|           |Ent/L2|Spc/L1| RCmd | RAlt | RCtl |  F15 |  F16   |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |      |      |                                       |      |      |      |      |        |
 *   `----------------------------------'                                       `------------------------------------'
 */
[L_0] = LAYOUT_ergodox(
        ...
        KC_F13,  KC_F14,  KC_LCTL, KC_LALT, KC_LCMD, LT(L_1, KC_BSPC), LT(L_2, KC_TAB),
        ...
        LT(L_2, KC_ENTER), LT(L_1, KC_SPACE), KC_RCMD, KC_RALT, KC_RCTL, KC_F15, KC_F16,
                 _______, _______, _______, _______, _______,
        _______, _______,
        _______,
        _______, _______, _______
