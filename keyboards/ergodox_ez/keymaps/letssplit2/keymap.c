 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
 * | F13    |      | LCtl | LAlt | LCmd |Bks/L1|Tab/L2|           |Ent/L2|Spc/L1| RCmd | RAlt | RCtl |      |  F16   |
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |      |      |      |      |      |                                       |      |      |      |      |        |
 *   `----------------------------------'                                       `------------------------------------'
 */
[L_0] = LAYOUT_ergodox(
        ...
        KC_F13,  TG(L_3), KC_LCTL, KC_LALT, KC_LCMD, LT(L_1, KC_BSPC), LT(L_2, KC_TAB),
        ...
        LT(L_2, KC_ENTER), LT(L_1, KC_SPACE), KC_RCMD, KC_RALT, KC_RCTL, _______, KC_F16,
                 _______, _______, _______, _______, _______,
        _______, _______,
        _______,
        _______, _______, _______
...
[L_1] = LAYOUT_ergodox(
       ...
       KC_F14,  _______, _______, _______, _______, _______, _______,
       _______, _______, _______, _______, _______,
                                                    _______, _______,
                                                             _______,
                                           _______, _______, _______,
       ...
       _______, _______,   KC_0,    KC_EQL,  KC_DOT,  KC_MINS, KC_F15,
                           _______, _______, _______, _______, _______,
       _______, _______,
       _______,
       _______, _______, _______
...
[L_2] = LAYOUT_ergodox(
       ...
       _______, _______, KC_PLUS, KC_EQL,  KC_MINS,  _______, _______,
       ...
       // right hand
       _______, _______, _______, _______, _______, _______, _______,
       _______, KC_M,    KC_Y,    KC_N,    KC_U,    _______, _______,
...
[L_3] = LAYOUT_ergodox(
        // left hand
        _______, _______, _______, KC_K,    KC_S,    KC_F,    _______,
        _______, _______, KC_D,    KC_V,    KC_E,    _______, _______,
        _______, _______, _______, _______, KC_B,    KC_T,
        _______, _______, _______, _______, _______, _______, _______,
        _______, _______, _______, _______, _______,
                                                     _______, _______,
                                                              _______,
        ...
        // right hand
        _______, KC_O,    KC_I,    KC_L,    KC_SCLN, KC_R,    _______,
        _______, KC_M,    KC_Y,    KC_N,    KC_U,    KC_P,    _______,
                 KC_J,    KC_H,    _______, _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______,
                 _______, _______, _______, _______, _______,
        _______, _______,
        _______,
